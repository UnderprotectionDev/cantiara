...
**Dev seed** — [`docs/agents/dev-database-seed.md`](docs/agents/dev-database-seed.md). Reset workspace demo data with `bun run db:seed`; hosted Neon requires `SEED_CONFIRM=hosted`.
