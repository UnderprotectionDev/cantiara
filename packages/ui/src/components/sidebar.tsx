...
import { useIsMobile } from "@cantiara/ui/hooks/use-mobile";
...
function SidebarProvider({
  ...
  const setOpen = useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // biome-ignore lint/suspicious/noDocumentCookie: Keep the shadcn sidebar persistence contract.
