...
- **Dış yüzeyin sahiplik sınırı diğer alan belgeleriyle şöyle bölünür.** Bir yayın veya paylaşım eyleminin hangi kaynak kayıtlardan doğduğu, kullanıcıya neyi önerdiği ve iş akışında nerede tetiklendiği ilgili alan belgesinde; Dış yüzeyin, Onaylı snapshot revizyonunun, ziyaretçi erişiminin, canlılık işaretinin ve iptalin davranışı yalnız bu belgede yaşar. [Proje Sürümü yayın hazırlığı](12-github-and-project-releases.md#sürüm-kanıt-paketi-ve-yayın-hazırlığı) yayın anında hangi etiket, changelog bağlantısı ve gelişim akışı olayının önerileceğini belirler; bu belge onaylananın snapshot'a nasıl uygulandığını ve dışarıdan nasıl görüneceğini belirler. [Saklama, silme ve güvenlik redaksiyonu](13-data-security-and-portability.md#saklama-ve-guvenli-silme-sureleri) yaşam geçişini ve sürelerini tetikler; bu belge tetiklenen yüzeyin erişim sonucunu tanımlar.
