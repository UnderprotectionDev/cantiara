...
| `schema_version` | Zorunlu dışa aktarma sözleşmesi sürümüdür; ilk değer `test-handoff-package/1`dir. Bilinmeyen bir paket sözleşmesi sürümü sessizce yükseltilmez veya tahmin edilmez. |
