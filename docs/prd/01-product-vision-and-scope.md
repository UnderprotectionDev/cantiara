...
- **PRD'nin normatif açıklama dili ve kullanıcıya dönük açıklayıcı ürün belgeleri Türkçe; kaynak kod, kod içi adlandırmalar ve ilk ürünün kullanıcı arayüzü dili İngilizcedir.** Navigasyon, düğme, durum, sistem mesajı, doğrulama hatası ve ürünün sağladığı varsayılan şablon metni İngilizce olur; kullanıcı içeriği çevrilmez. Protokol, dış sağlayıcı ve ekosistem tarafından zorunlu kılınan özgün adlar korunur. PRD Türkçe domain terimini kullanabilir fakat kullanıcıya gösterilen kesin terim [ortak sözlükteki İngilizce UI etiketiyle](02-domain-model-and-lifecycle.md#terim-sözlüğü) belirtilir. Arayüz dili kullanıcı tercihi değildir; tarih, saat ve sayı biçimi Hesap locale'ından, para birimi ise ilgili ticari belgeden gelir.
