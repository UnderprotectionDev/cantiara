...
- **Consumers.** 07 supplies profile, stages, enabled areas. Later work/docs/test/incident features fill modules. 15/67/69 must not be implemented here. Açık Soru visibility stays workflow 16, not this surface.
