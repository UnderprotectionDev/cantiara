...
- **Session module.** Project-scoped. Consent gates quote/identifying notes/files/share. Widening share cannot reopen old unconsented bytes. Notes are typed; mixed default refused. Convert preview bound to exact session version via Evidence seam.
