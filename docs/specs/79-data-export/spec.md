...
- **Documents and freeze exports (PRD wins).** Phase-context tamamlanma mentions selected Documents; PRD 13 excludes Documents from this general CSV/JSON catalog and [tek belge dışa aktarma](../../prd/07-documents-and-knowledge.md#tek-belge-dışa-aktarma) (workflow 31) owns single-document Markdown/PDF. During Hesap kapanma dondurması, [Hesap kapatma](../../prd/03-account-platform-operations.md#hesap-kapatma) keeps this seam available on the frozen set alongside 82; PRD 13's sentence that selected Markdown/JSON/CSV export stops during freeze does not apply.
