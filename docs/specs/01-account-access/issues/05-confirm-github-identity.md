...
- [ ] Tüketim arayüzü tüketen feature'ların işlem kimliğiyle yetkiyi bir kez harcamasına izin verir; `account-closure-start` ile `account-closure-cancel` ayrı kimliklerdir. Ürün içi sahte yüksek risk eylemi açılmaz. İsim yazarak onay bu ticket'ta yoktur.
