...
- **Snapshots.** Start scope and close scope are separate immutable historical snapshots. They do not replace live Work. Close compares start/in/out/completed/still-open neutrally. Optional target-date comparison uses existing history and close instant; no new actual-date field, health, or score.
