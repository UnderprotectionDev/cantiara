...
- **What a good test is.** Tests observe Favorites through add, remove, list, open-source, and the counterpart that source Project/type/status/planning did not change. They do not assert shell chrome or Drizzle membership rows.
