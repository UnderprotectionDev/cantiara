...
- **Catalog.** Same closed family table as 79 for CSV/JSON. Markdown → Document in Project or Wiki. First-party Document JSON → Document family. Not: ZIP, folder, workspace import, Project create, External Surface, automation, Starter Configuration, GitHub-as-truth, Technical Diagram editable JSON, test-report envelope as Work/Document.
