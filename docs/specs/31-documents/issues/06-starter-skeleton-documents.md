# 06 — Persona, Retrospective, Launch Plan iskeletleri

**What to build:** Proje kabuğunun seçtiği `Persona`, `Retrospective` ve `Launch Plan` iskeletleri bu feature’da yalnız sözleşmeli İngilizce boş bölüm başlıklarıyla Belge olarak yaşar. Oluşunca normal Belgedir. Örnek kişi, bulgu, görev veya karar üretmez. Katalog seçimi proje kabuğundadır; duvar iskeletleri burada yoktur.
