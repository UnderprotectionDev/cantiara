# 03 — Başlangıç iskeleti kataloğu seçimi

**What to build:** Blank dışındaki yapılandırma kaynakta tanımlı boş iskelet kataloğunu seçer: `Persona`, `Retrospective`, `Launch Plan` (Belge); `Sitemap`, `Customer Journey` (Proje Duvarı). Seçim yaşayan Belge veya Duvar kaydı üretmez. Yaşayan boş başlık yapıları 31 ve 51’de oluşur.

**Blocked by:** 02 — Başlangıç yapılandırmaları
