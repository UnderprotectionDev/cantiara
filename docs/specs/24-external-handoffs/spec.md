...
- **Acceptance.** For Issue #166, bind tests to starting an owned Work handoff, selecting the current Work revision and permitted GitHub identifiers, keeping its Markdown package frozen, and not starting an external runner. The broader acceptance journey for repeated handoffs, late return, cancel, reconcile, signals, and Test Handoff separation remains future feature work; this slice does not claim it complete.
