...
- Tamamlanmamış İş formu otomatik Taslak olarak korunur.
- Taslak arama, planlama ve paylaşım gerçeğine girmez; tek İşe açıkça kesinleşir.

## Kapsam Sınırları

- Taslağı İş, Yakalama veya Belge taslağı sayma.
- Taslağı evrensel arama veya Dış yüzey içeriği yapmak.
- Aynı formdan birden fazla İş kesinleştirme.
