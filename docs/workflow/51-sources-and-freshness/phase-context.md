...
Bu feature kaynaklar ve kanıt tazeliğini tamamlar. Kanıt ilişkisi, Dosya Eki ve akıllı bağlantının ikinci doğruluk kaynağı olması burada yoktur.
...
Kurucu başlık ve özeti görür; sayfayı ürün içine gömmez.

Önizleme Kaynak kaydının kendisi değildir. Üstveri yardımıdır.
