...
Proje yapısı aşamaları, alanları, durumları ve özel alanları korunan semantik içinde değiştirir. Ürünün kayıt anlamı bozulmaz. Aşamalar sıralı state machine değildir; birden fazla aşama aynı anda Aktif olabilir. Hazır Proje alanları kapalı katalogdandır; gizlenen alan içerik kaybetmez ve kayıt yaşamını değiştirmez.
...
Genel bakış dashboard skoru veya durum kapısı değildir. Çalışma Alanı genel bakışı tek Proje özeti olmaz.
...
- Yapılandırmasız Proje veya özellikleri kaldırılmış boş veri modeli.
- Başlangıç iskeletini otomatik karar, görev veya retrospektif doldurma.
...
- Çalışma Alanı genel bakışını tek Proje özeti yapmak.
