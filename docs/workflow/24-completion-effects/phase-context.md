...
Bitiriş, işin bittiğine dair görünür bir kutlama verir. Otomasyon, dış olay veya Vazgeçildi sonucu efekt üretmez. Azaltılmış hareket ve çizim bütçesi kalite kuralıdır; başarı geri bildirimini gizlemez.
...
Tetikleyici dış araç, test sonucu veya otomasyon kapanışı değildir. Azaltılmış hareket dekorasyonu düşürür; `İş tamamlandı` bildirimi kalır.
...
- Azaltılmış hareket başarı geri bildirimini kaldırmaz.
